...
function BeamDoc(legacyState) {

    let state = (legacyState === undefined) ? Automerge.from({
    ...
    this.join = (socketId, collabName, collabState) => {
        ...
        console.log(JSON.stringify(state.collabs, undefined, 2));
...
function DocumentStore() {
    ...
    this.addDoc = function (docId, doc) {
        console.log('Add doc called with id & doc: ');
        console.log(docId);
        console.log(JSON.stringify(doc));
        docs[docId] = new BeamDoc(doc);
    };
